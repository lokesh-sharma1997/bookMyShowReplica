...
public class MovieController {
	...
	public ResponseEntity<MovieDto> createMovie(@RequestPart("movie") String movieJson,
	...
	@GetMapping("/filter")
	public List<MovieDto> filterMovies(@RequestParam(required = false) List<String> languages,
			@RequestParam(required = false) List<String> genres, @RequestParam(required = false) List<String> formats,
