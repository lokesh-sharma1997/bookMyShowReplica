...
public class SecurityConfig {
    ...
    public SecurityConfig(CustomUserDetailsService userDetailsService, JwtService jwtService, TokenService tokenService) {
    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        http.csrf(AbstractHttpConfigurer::disable)
            .authorizeHttpRequests(authz -> authz
                ...
                .requestMatchers("/api/events/get-all-events","/venues/city/{city}","/venues/getAll", "/api/city/**", "/venue/getAll", "/api/states",
