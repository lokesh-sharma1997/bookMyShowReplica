...
public class UserProfileServiceImpl implements UserProfileService {
    ...
    // Checks if a string is a default placeholder value
    ...
    // Used to update a field of an entity if value is not default
    ...
    // Updates user and profile fields, checking for unique email/username, then saves them
    @Override
    ...
    // Retrieves user profile response by userId
    @Override
    ...
    // Maps user and profile entities to response DTO
